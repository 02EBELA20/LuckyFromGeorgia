...
"[project]/pages/api/vip-winner.js [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    try {
        ...
        const db = client.db('winnersDB');
        const winnersCollection = db.collection('winners');
        // ვიღებთ მხოლოდ ბოლო (ბაზაში ბოლოს დამატებულ) გამარჯვებულს
        const lastWinner = await winnersCollection.find().sort({
            date: -1
        }).limit(1).toArray();
        if (!lastWinner.length) {
            return res.status(404).json({
                message: "No winners found"
            });
        }
        res.status(200).json(lastWinner[0]); // აბრუნებს ბოლო გამარჯვებულს
    } catch (error) {
        res.status(500).json({
...
"[project]/node_modules/next/dist/esm/build/templates/pages-api.js { INNER_PAGE => \"[project]/pages/api/vip-winner.js [api] (ecmascript)\" } [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$vip$2d$winner$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/pages/api/vip-winner.js [api] (ecmascript)");
;
;
;
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$vip$2d$winner$2e$js__$5b$api$5d$__$28$ecmascript$29$__, 'default');
const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$helpers$2e$js__$5b$api$5d$__$28$ecmascript$29$__["hoist"])(__TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$vip$2d$winner$2e$js__$5b$api$5d$__$28$ecmascript$29$__, 'config');
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$pages$2d$api$2f$module$2e$compiled$2e$js__$5b$api$5d$__$28$ecmascript$29$__["PagesAPIRouteModule"]({
    definition: {
        kind: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$kind$2e$js__$5b$api$5d$__$28$ecmascript$29$__["RouteKind"].PAGES_API,
        page: "/api/vip-winner",
        pathname: "/api/vip-winner",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$vip$2d$winner$2e$js__$5b$api$5d$__$28$ecmascript$29$__
}); //# sourceMappingURL=pages-api.js.map
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d183f3._.js.map